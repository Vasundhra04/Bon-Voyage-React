          ...
          <Paper variant='outlined' style={{width:'1200px',height:'710px', borderRadius:'20px' ,opacity:'0.7'}}>
            ...
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to='../Choice'>
                    <Button variant='contained' color='secondary'>HYDERABAD</Button>
                  </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to='../Choice'>
                    <Button variant='contained' color='secondary'>SHIMLA</Button>
                  </Link>
                </Typography>
              </div>
            </div>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to='../Choice'>
                    <Button variant='contained' color='secondary'>DELHI</Button>
                  </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to='../Choice'>
                    <Button variant='contained' color='secondary'>KASHMIR</Button>
                  </Link>
                </Typography>
              </div>
            </div>
